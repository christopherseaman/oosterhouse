...
2. **SPSS Comparison:**
    ...
    * The table below provides a detailed comparison of raw p-values from Python (using both Welch's and Student's t-tests) against the original SPSS values:
        ...
        |                                           | SS4 avg            | 0.036                        | **0.160**                      | **0.159**⚠️       | Welch's p < 0.05; **Student's matches SPSS very closely (p > 0.05).** |
        |                                           | Total Score Avg    | 0.044                        | **0.102**                      | **0.102**⚠️       | Welch's p < 0.05; **Student's matches SPSS exactly (p > 0.05).**      |
        ...
        |                                           | SS2 avg            | 0.501                        | **0.477**                      | **0.737**⚠️       | **Notable difference persists** for both Welch's and Student's.       |
